...
<form action="/gestion_hospitalaria/{{$gestiones->ID_HOSPITALIZACION}}" method="post" class="text-bg-dark ">
    ...
    <label for="TIPO_DOC_PACIENTE" class="form-label">TIPO DOCUMENTO DEL PACIENTE></label>
    ...
    <div class="mb-3">
        <label for="COD_HOSPITAL" class="form-label">CODIGO DE HOSPITAL</label>
        <input value="{{$gestiones->COD_HOSPITAL}}" type="text" class="form-control text-bg-secondary" id="COD_HOSPITAL" name="COD_HOSPITAL">
    </div>
    <div class="mb-3">
        <label for="FEC_INGRESO" class="form-label">FECHA INGRESO</label>
